      ...
      <CommonMaxWidth>
        ...
        <p>
          <ol>
            ...
            <li>
              Once you're done, create a git branch named
              {' '}
              <code>your-name/challenge</code>
              , and create a pull request to
              {' '}
              <a href="https://github.com/SourceSage/sourcesage-challenges">
                this repository
              </a>
            </li>
          </ol>
        ...
        <p>
          We want to see how much of our frontend stack you can pick up within the time given, and your ability to make fix an existing codebase, amongst other things.
        </p>
        <p>
          All the best!<br /><br />
          <em>Andrew</em><br />
        ...
        <p>
          p.s. feel free to drop me an email at
          {' '}
          <code>andrew@sourcesage.co</code>
          {' '}
